...
class MoviesBloc extends Bloc<MoviesEvent, MoviesState> {
  ...
  Future<void> _onLoadMovieDetails(
    ...
    try {
      ...
      final cast = await _movieRepository.getMovieCast(event.movieId);
      final images = await _movieRepository.getMovieImages(event.movieId);
      final similarMovies =
          await _movieRepository.getSimilarMovies(event.movieId);
